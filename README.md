...
- The runnable jar file can be found in [build/libs](build/libs/level-2-programming-assesment-1.0-SNAPSHOT.jar)
---
...
This project uses the gradle build system for using kotter (TUI)
